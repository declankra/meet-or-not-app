  ...
  return (
    <div className="learn-more-page">
      ...
      <div className="content">
        ...
        <p>
          for now, I’d appreciate it if you <strong>provided feedback on the product
          <a href="https://docs.google.com/forms/d/e/1FAIpQLSdHJbr616yjhPKzp88Kty7hnTVey2ucIcdF8OYE1euaTG3n5g/viewform" target="_blank" rel="noopener noreferrer"> here</a>.</strong>
        </p>
